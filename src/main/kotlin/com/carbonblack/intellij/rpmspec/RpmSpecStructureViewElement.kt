...
class RpmSpecStructureViewElement(val element: NavigatablePsiElement) :
    StructureViewTreeElement,
    Navigatable by element {

    override fun getPresentation(): ItemPresentation = element.presentation ?: run {
    ...
    override fun getChildren(): Array<TreeElement> = element.children
